...
if ($('#HSDRate').length) {
    ...
    const rates = [];
    const date = ['2022/03/04', '2022/03/04', '2022/03/04', '2022/03/04', '2022/03/04', '2022/03/04', '2022/03/04'];
    $.get("/Home/GetHSDRate", function (data) {

        $.each(data, function (index, row) {
            rates.push (row.Rate)
            /*date.push(row.Date)*/
        });
        var ctx = document.getElementById("HSDRate").getContext('2d');
        var chart = new Chart(ctx, {
            // The type of chart we want to create
            type: 'bar',
            // The data for our dataset
